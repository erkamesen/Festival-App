...
from controller.controller import name_control, mail_control, generate_ticket, logger
from pkg.iyzico import Iyzico
    ...
    if request.method == "GET":
        ...
        if session_datas:
            ...
            if datas.get("status") == "success" and datas.get("paymentStatus") == "SUCCESS":
                logger(control="successful", process=datas)
                ...
                logger(control="failure", process=datas)
                return render_template("404.html")
